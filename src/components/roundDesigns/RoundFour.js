  ...
  return (
    <div className="w-[800px] h-[800px] rounded-full absolute top-0 left-1/3">
      <div className="w-full h-full relative animate-reverse-spin">
        ...
        <div className="w-52 h-52 rounded-full bg-yellow-400 absolute -bottom-10 left-16 blur-3xl"></div>
        <div className="w-28 h-28 rounded-full bg-yellow-400 absolute bottom-32 right-20 blur-2xl"></div>
